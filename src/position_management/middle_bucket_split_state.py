...
MIDDLE_BUCKET_SPLIT_ACTUAL_ORDER_MODE_PARTIAL_SPLIT_SLOW_PENDING = "PARTIAL_SPLIT_SLOW_PENDING"
MIDDLE_BUCKET_SPLIT_ACTUAL_ORDER_MODE_PARTIAL_SPLIT_FAST_PENDING = "PARTIAL_SPLIT_FAST_PENDING"
